...
def parse_args():
    ...
    parser.add_argument("--model_checkpoint", type=str, default="models/gemma2-9b-cpt-sea-lionv3-instruct-SemEval-sun")
...
def main(args):
    ...
    def preprocess_function(example):
        ...
        example["messages"] = [
            {
                "role": "user",
                "content": f"Apakah teks berikut mengekspresikan emosi {emotion_map[example['emotion']]}?\nKalimat: {example['text']}\nJawaban: ",
            },
        ]
        return example
    ...
    for message in tqdm(dataset["messages"]):
